...
class EXTNFTServiceTest {
    ...
    fun `fetchCollectionNFTs Mutant Space Apes`() = runTest {
        ...
        assertEquals("https://gikg4-eaaaa-aaaam-qaieq-cai.raw.icp0.io/?tokenid=jkgnc-hakor-uwiaa-aaaaa-deacb-eaqca-aaaaa-a", nftCollection.first().nftImageUrl)
        ...
        assertEquals("https://gikg4-eaaaa-aaaam-qaieq-cai.raw.icp0.io/?tokenid=hwf6d-cqkor-uwiaa-aaaaa-deacb-eaqca-aaaaa-q", nftCollection[1].nftImageUrl)
        ...
        assertEquals("https://gikg4-eaaaa-aaaam-qaieq-cai.raw.icp0.io/?tokenid=op4gl-3qkor-uwiaa-aaaaa-deacb-eaqca-aaaf2-q", nftCollection.last().nftImageUrl)
    }
